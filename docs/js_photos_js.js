...
jquery__WEBPACK_IMPORTED_MODULE_0___default()(document).on('DOMContentLoaded', function () {
    ...
    if (window.innerWidth < 480) {
        ...
        swiperTabs = new swiper_core__WEBPACK_IMPORTED_MODULE_2__.default('.swiper-container', {
            slidesPerView: 'auto',
