...
/* harmony import */ var _pagination__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./pagination */ "./js/pagination.js");
...
jquery__WEBPACK_IMPORTED_MODULE_0___default()(document).on('DOMContentLoaded', function () {
    ...
    if (window.innerWidth < 992) {
        ...
        swiperTabs = new swiper_core__WEBPACK_IMPORTED_MODULE_3__.default('.swiper-container', {
            slidesPerView: 'auto',
            slideToClickedSlide: true,
            freeMode: true
        })
        jquery__WEBPACK_IMPORTED_MODULE_0___default()('.swiper-slide:nth-child(n-1)').on('click', function () {
    ...
    _pagination__WEBPACK_IMPORTED_MODULE_2__.default.Init(document.getElementsByClassName('pagination'), {
        size: 105, // pages size
...
/******/ 		
/******/ 		var deferredModules = [
/******/ 			["./index.js","vendors-node_modules_jquery_dist_jquery_js-node_modules_swiper_esm_components_core_core-class_js"]
/******/ 		];
